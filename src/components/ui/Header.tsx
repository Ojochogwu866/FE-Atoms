...
const Header: React.FC<HeaderProps> = ({ title, notificationCount }) => {
    ...
    const renderCartDrawer = () => (
        <Drawer isOpen={isCartOpen} onClose={() => setIsCartOpen(false)} width="50%">
            <div className="space-y-6">
                <h2 className="text-2xl font-bold">Shopping Cart</h2>
                {cartItems.length === 0 ? (
                    <p className="text-gray-500">You currently have no products in your cart, please add products to continue</p>
                ) : (
                    <>
